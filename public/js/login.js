$(document).ready(function() {
    ...
    function Login() {
        ...
        // Show loading state
        $('.login-btn').prop('disabled', true).html('<span class="spinner-border" role="status" aria-hidden="true"></span> Loading...');
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.message === 'Login successful!' || response.message === 'Login successful') {
                    Swal.fire({
                        ...
                        } else if (response.role == 4 || response.role == 2 || response.role == 3) {
