                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="time" class="form-control" id="schedule_time_in" name="time_in" value="{{ old('time_in', optional($data['schedule'] ?? null)->time_in ? Carbon\Carbon::parse(optional($data['schedule'] ?? null)->time_in)->format('H:i') : '') }}">
                                        <div class="invalid-feedback" id="time_in_error"></div>
                                    </div>
                                    <div class="col">
                                        <label for="schedule_time_out" class="form-label">End Time</label>
                                        <input type="time" class="form-control" id="schedule_time_out" name="time_out" value="{{ old('time_out', optional($data['schedule'] ?? null)->time_out ? Carbon\Carbon::parse(optional($data['schedule'] ?? null)->time_out)->format('H:i') : '') }}">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                     <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="base_salary">Base Salary</label> {{-- Changed label 'for' --}}
