                        ...
                        <div class="swiper-slide">
                            <div class="row gy-4 event-item">
                                ...
                                <div class="col-lg-6 pt-4 pt-lg-0 content">
                                    ...
                                    <ul>
                                        <li><i class="bi bi-check2-circle"></i> <span>Ullamco laboris nisi ut aliquip ex
                                                ea commodo consequat.</span></li>
                                        <li><i class="bi bi-check2-circle"></i> <span>Duis aute irure dolor in
                        ...
                        <form id="serviceFeedbackForm" enctype="multipart/form-data" action="" method="post"
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <small id="char-count" class="form-text text-bg-danger text-muted">1000 characters remaining</small>
