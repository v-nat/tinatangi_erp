...
<?php $__env->startSection('headings'); ?> Create Purchase Request <?php $__env->stopSection(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1 col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="unit_price" class="form-control py-3" min=1 required readonly
                                            placeholder="0.00" name="unit_price">
