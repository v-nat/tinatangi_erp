...
<?php $__env->startSection('content'); ?>
    ...
    <section class="section">
                    ...
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h6 class="font-extrabold mb-0"><?php echo e($overtimes); ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h6 class="font-extrabold mb-0"><?php echo e($leaves); ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id='calendar' data-events-url="<?php echo e(route('hr.schedules')); ?>"></div>
            </div>
        </div>
        </div>
