<?php if(auth()->user()->employeeRS?->department == 1): ?>
    ...
    <?php $__env->startSection('sidebar-title'); ?> Administrator <?php $__env->stopSection(); ?>
    ...
    <?php $__env->startSection('crm-admin'); ?> Customer Relationship Management <?php $__env->stopSection(); ?>
    <?php $__env->startSection('admin'); ?> d-block <?php $__env->stopSection(); ?>
    ...
    <?php $__env->startSection('crm-dashboard'); ?>
