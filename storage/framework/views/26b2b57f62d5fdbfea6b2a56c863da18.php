                            ...
                            <table class="table table-bordered table-sm mb-0">
                                <tbody>
                                    ...
                                    <tr class="table-light">
                                        ...
                                        <td class="px-3 py-2">
                                            <span id="modal_approved_by"
                                                class="text-success fw-semibold"><?php echo e(Auth::user()->name ?? 'System User'); ?></span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-2">
                                            <span id="modal_approval_date"><?php echo e(date('Y-m-d')); ?></span>
                                            <input type="hidden" name="approval_date" value="<?php echo e(date('Y-m-d H:i:s')); ?>">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
<?php /**PATH C:\Users\Nathaniel\Documents\Nathaniel\Thesis A\tinatangi_erp\resources\views/dashboard-test.blade.php ENDPATH**/ ?>